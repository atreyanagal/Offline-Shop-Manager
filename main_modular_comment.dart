...
class _TodoAppState extends State<TodoApp> {
  ...
  Card buildTodoItem(List<Todo> filteredTodos, int index) {
    ...
    return Card(
      child: ListTile(
        ...
        onTap: () {
          toggleTodoStatus(filteredTodos, index);
        },
        onLongPress: () {
  ...
  Column buildTodoTrailing(List<Todo> filteredTodos, int index) {
    return Column(
      children: [
        Row(
          ...
          children: [
            ...
            IconButton(
              ...
              onPressed: () {
                showEditTodoDialog(filteredTodos, index);
              },
            ),
            IconButton(
  ...
  // Decrements the quantity of a todo item
